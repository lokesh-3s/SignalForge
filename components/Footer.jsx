...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-slate-200/30 bg-white/80 backdrop-blur-sm dark:border-slate-800/60 dark:bg-slate-900/80">
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex gap-6">
              <a
                ...
                className="text-slate-600 transition-colors hover:text-emerald-500 dark:text-slate-400 dark:hover:text-emerald-400"
                aria-label="LinkedIn"
              >
